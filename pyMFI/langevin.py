...
PRINT FILE=position_{} ARG=p.x,p.y STRIDE=10""".format(
                pace, sigma, sigma, height, biasfactor, tag, tag
            ),
            file=f,
        )
...
PRINT FILE=positioninve_{} ARG=p.x,p.y STRIDE=10""".format(
                pace, sigma, sigma, height, biasfactor, tag, tag
            ),
            file=f,
        )
